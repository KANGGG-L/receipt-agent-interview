...
from app import db
# 单位换算单一事实源（SSOT）：本模块保持原符号名 re-export，
# `from app.services.costing_service import convert_unit_quantity` 等既有引用不受影响。
from app.services.unit_factors import (  # noqa: F401
    DIMENSION_COUNT,
    DIMENSION_VOLUME,
    DIMENSION_WEIGHT,
    UNIT_VOLUME_TO_L,
