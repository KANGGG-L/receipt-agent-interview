...
### 4.0 市场定价锚点（Airpurchase 按张定价参考）

| 参考项 | 值 | 说明 |
|:---|:---:|:---|
| 市场竞品（Airpurchase） | **HK$268 / 月含 50 张，超出部分 HK$1/张** | 50 张均价 HK$5.36/张；120 张/月均价 HK$2.82/张 |
| 本产品推荐定价 | **对齐 Airpurchase 阶梯结构** | 基础套餐 + 低价增量，兼顾价格竞争力 |

> 典型店 120 张/月，对齐 Airpurchase 定价：ARPU ≈ HK$338/月（268 + 70×1），均价 HK$2.82/张。
> 多店共享 RDS 后 GM 达 **94%（10 店）→ 99%（100 店+）**。
...
- **单店月度底层算力成本**：120 张 × HK$0.020 = **HK$ 2.40 / 月**（旧口径；新口径含存储后单张 HK$0.0103，见下）。
- **单店月度客服与基础设施均摊**：**HK$ 6.00 / 月**。
- **单店月度服务总成本（旧口径）**：HK$ 2.40 + HK$ 6.00 = **HK$ 8.40 / 月**。
- **单店月度毛利（月费制，旧口径）**：HK$ 99.00 - HK$ 8.40 = **HK$ 90.60 / 月**。
- **产品底层毛利率 (Gross Margin)**：**> 91.5%**（旧口径；多店共享 RDS 场景）。

#### 4.2.1 对齐 Airpurchase 阶梯定价 + 全链路成本（新口径，2026-09-01）

单张全链路成本（含 AI 解析 Token + S3 存储 7 年 + RDS 分摊）随规模变化。
定价对齐 Airpurchase：HK$268/月含 50 张 + 超出 HK$1/张，典型店 120 张/月 → ARPU HK$338，均价 HK$2.82/张。

| 规模 | 单张全链路成本 | 均价 HK$2.82/张 毛利 | **GM** |
|:---|:---:|:---:|:---:|
| 10 店共享 | HK$0.1626 | 毛利 HK$2.66 | **94.2%** |
| 100 店共享 | HK$0.0255 | 毛利 HK$2.80 | **99.1%** |
| 1,000 店共享 | HK$0.0118 | 毛利 HK$2.81 | **99.6%** |

> **新口径结论**：对齐 Airpurchase 阶梯定价（268/月含 50 张 + HK$1/张）后，**10 店规模 GM 达 94.2%，100 店以上超 99%**。
